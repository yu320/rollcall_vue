        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">指定角色</th>
          ...
          <tbody class="bg-white divide-y divide-gray-100">
            <tr v-for="code in codes" :key="code.id" class="hover:bg-gray-50">
              ...
              <td data-label="指定角色" class="px-6 py-4 text-sm text-gray-600">{{ getRoleDisplayName(code.roles?.name) || '訪客 (預設)' }}</td>
