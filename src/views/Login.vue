<template>
  <div class="login-container flex items-center justify-center p-4">
    ...
    <!-- Login Card -->
    <div v-if="!authStore.isLoading" class="login-card w-full max-w-md rounded-2xl p-8 md:p-10">
...
const handleLogin = async () => {
  ...
  // 如果登入成功，auth store 中的 watcher 會自動導航
};
...
<style scoped>
/* 這裡可以放置此元件專用的樣式，
   但大部分樣式已移至 src/assets/styles/main.css */
</style>
