 ...
 */
async function recordAdminAuditLog(supabaseAdmin, adminUserId, logDetails) {import { createClient } from '@supabase/supabase-js';
...
export default async function handler(req, res) {
  ...
  // 【修正】從請求主體中解構出 registration_code
  ...
  try {
    ...
    // 【修正】使用 Supabase Admin 客戶端直接更新 profiles 表格，並包含 registration_code
